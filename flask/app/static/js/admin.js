function add_point() {
    ...
    fetch(`http://${location.hostname}/api/add_point/${team}/${points}`)
...
function set_point() {
    ...
    fetch(`http://${location.hostname}/api/set_point/${team}/${points}`)
        .then(response => response.text())
        .then(response => { alert(response); });
}
...
function finish_misson() {
    ...
    fetch(`http://${location.hostname}/api/finish_mission/${team}`)
        .then(response => response.text())
        .then(response => { alert(response); });
}
...
function create_team() {
    ...
    fetch(`http://${location.hostname}/api/create_team/${team}/${position}`)
        .then(response => response.text())
        .then(response => { alert(response); });
}
...
function delete_team() {
    ...
    fetch(`http://${location.hostname}/api/delete_team/${team}`)
        .then(response => response.text())
        .then(response => { alert(response); });
}
...
function join_team() {
    ...
    fetch(`http://${location.hostname}/api/join_team/${team}/${player_name}/${admin}`)
        .then(response => response.text())
        .then(response => { alert(response); });
}
...
function leave_team() {
    ...
    fetch(`http://${location.hostname}/api/leave_team/${player_name}`)
        .then(response => response.text())
        .then(response => { alert(response); });
}
...
function move_to_location() {
    ...
    fetch(`http://${location.hostname}/api/move_to_location/${team}/${location}`)
        .then(response => response.text())
        .then(response => { alert(response); });
}