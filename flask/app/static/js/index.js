...
async function station_info(station_name) {
    ...
    try {
        const [data, team_data] = await Promise.all([
            fetch(`http://${location.hostname}/api/station/${station_name}`).then(response => response.json()),
            fetch(`http://${location.hostname}/api/team/${team}`).then(response => response.json())
        ]);
...
async function showLocate() {
    try {
        const response = await fetch(`http://${location.hostname}/api/teams`);
...
async function showMap() {
    try {
        const response = await fetch(`http://${location.hostname}/api/collapse_status`);
        const data = await response.json();
...
async function showCollapse_time() {
    try {
        const response = await fetch(`http://${location.hostname}/api/next_collapse_time`);
        const data = await response.json();
...
async function showImprisoned() {
    const team = document.querySelector('#team').innerHTML;
    try {
        const response = await fetch(`http://${location.hostname}/api/team/${team}`);
        const data = await response.json();
    ...
    return new Promise((resolve, reject) => {
        ...
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(async (position) => {
                try {
                    const response = await fetch(`http://${location.hostname}/api/gps_location/${team}/${position.coords.latitude}/${position.coords.longitude}`);
                    const data = await response.json();
